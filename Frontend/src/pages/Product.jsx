...
const Product = () => {
  ...
  const handleAddToCart = () => {
    if (!token) {
      ...
      toast.success("Enter a Email and Password")
    } else {
    ...
    <div className="border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100">
      ...
      <div className="mt-20">
        ...
        <div className="flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500">
          <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Eligendi amet qui inventore eius quasi, accusantium velit quidem perspiciatis odit, error recusandae! Eaque perferendis aliquid blanditiis optio omnis nihil rem quisquam. Lorem, ipsum dolor sit amet consectetur adipisicing elit. Similique, cum.</p>
        </div>
      </div>
